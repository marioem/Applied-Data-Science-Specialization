...
app.layout = html.Div([
    ...
    html.Div([
        html.Label("Select Statistics:", style={'font-family': 'Helvetica'}),
        dcc.Dropdown(
    ...
    html.Br(),
    html.Div([
        html.Label("Select Year (for Yearly Statistics only):", style={'font-family': 'Helvetica'}),
        dcc.Dropdown(
            id='select-year',
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'display': 'nline-block'})
            ]
...
# Total Advertisement Expenditure for each vehicle using pie chart
    ...
    # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        ...
        Y_chart4 = dcc.Graph(
            ...
            values='Advertising_Expenditure',
            names='Vehicle_Type',
            labels={'Vehicle_Type': 'Vehicle Type', 'Advertising_Expenditure': 'Total Advertising Expenditure'},
